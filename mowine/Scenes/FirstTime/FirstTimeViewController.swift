...
class FirstTimeViewController: UIViewController {
    ...
    private func linkToFacebookLogin(fbToken: String) {
        ...
        worker.login(type: .facebook, token: FacebookToken(token: fbToken), completion: socialSignInComplete)
    }
    ...
    func linkToGoogleLogin(idToken: String, accessToken: String) {
        loadingView.show("Signing in...")
        worker.login(type: .google, token: GoogleToken(idToken: idToken, accessToken: accessToken), completion: socialSignInComplete)
    }
