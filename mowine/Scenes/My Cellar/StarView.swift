...
struct Star: Shape {
    ...
    func path(in rect: CGRect) -> Path {
        ...
        // position of the first point on the star (straight up)
        let initialPoint = CGPoint(x: center.x * cos(currentAngle), y: center.y * sin(currentAngle))
        ...
        // close the shape with a final line back to the start
        // necessary to display as an outline
