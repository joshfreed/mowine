...
public class DependencyInjection {
    public static func registerServices(container: DependencyContainer) {
        ...
        // Users
        container.register(.unique) { GetMyAccountQueryHandler(userRepository: $0, session: $1) }
        ...
        container.register(.unique) { CreateWineCommandHandler(wineRepository: $0, session: $1, createWineImages: $2, wineTypeRepository: $3) }
    ...
    public static func registerCommands(mediator: Mediator) {
        ...
        mediator.registerHandler(CreateWineCommandHandler.self, for: CreateWineCommand.self)
    }
    ...
    public static func registerQueries(mediator: Mediator) {
        ...
        mediator.registerHandler(GetMyAccountQueryHandler.self, for: GetMyAccountQuery.self)
    }
}
